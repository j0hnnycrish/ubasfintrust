              ...
              <Card className="bg-white/10 backdrop-blur border-white/20">
                <CardContent className="p-8">
                  <div className="text-center">
                    ...
                    <div className="text-red-200 mb-4">Free Transactions</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {accountTypes.map((account, index) => (
              <Card key={index} className={`relative shadow-lg hover:shadow-xl transition-shadow ${
                account.recommended ? 'border-2 border-red-500' : ''
              }`}>
                {account.recommended && (
                ...
                <CardHeader className="text-center">
                  ...
                  <div className="text-3xl font-bold text-red-600 my-4">{account.monthlyFee}</div>
              ...
              <Card className="bg-red-50 border-red-200">
                <CardContent className="p-6">
                  <div className="flex items-start space-x-3">
                    <Building className="h-6 w-6 text-red-600 flex-shrink-0 mt-1" />
                    <div>
                      <h3 className="font-semibold text-red-800 mb-2">Dedicated Support</h3>
